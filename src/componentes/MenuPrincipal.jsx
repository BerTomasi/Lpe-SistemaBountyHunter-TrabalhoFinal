            ...
            <AppBar position="static"
                ...
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Avatar sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} alt="Logo Hermes" src={LogoIfsul} />
                        <Typography
                            variant="h6"
                            noWrap
                                    ...
                                    {user &&
                                        <>
                                            <MenuItem onClick={handleOpenMenuManutencoes}>
                                                <Typography textAlign="center">Publicações</Typography>
                                            </MenuItem>
                                            <Menu
                                                sx={{ mt: '45px' }}
                                                id="menu-manutencoes"
                                            ...
                                            >
                                                <MenuItem onClick={handleCloseNavMenuManutencoes}
                                                    component={NavLink} to="servicos">
                                                    <Typography textAlign="center">servicos</Typography>
                                                </MenuItem>
                                            </Menu>
                                        </>
                                    }
